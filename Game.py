        ...
        if(board[row][0]["text"]==board[row][1]["text"]==board[row][2]["text"]
           and board[row][0]["text"]!=""):
            ...
            for column in range(3):
                board[row][column].config(foreground=color_yellow,background="purple")
            game_over=True
            return
    for column in range(3):
        ...
        if(board[0][0]["text"]==board[1][1]["text"]==board[2][2]["text"]
           and board[0][0]["text"]!=""):
            ...
            for i in range(3):
                board[i][i].config(foreground=color_yellow,background="purple")
            game_over=True
            return
        ...
        if(board[0][2]["text"]==board[1][1]["text"]==board[2][0]["text"]
           and board[0][2]["text"]!=""):
            ...
            board[0][2].config(foreground=color_yellow,background="purple")
            board[1][1].config(foreground=color_yellow,background="purple")
            board[2][0].config(foreground=color_yellow,background="purple")
            game_over=True
            return
...
label=tkinter.Label(frame,text=curr_player+"'s turn",foreground="white",background=color_gray,font=("Consolas",20))
